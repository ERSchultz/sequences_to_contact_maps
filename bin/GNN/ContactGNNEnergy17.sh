#! /bin/bash
#SBATCH --job-name=CGNNE17
#SBATCH --output=logFiles/ContactGNNEnergy17.out
...
rootName='ContactGNNEnergy17' # change to run multiple bash files at once
...
updateHiddenSizesList='1000-1000-128'
